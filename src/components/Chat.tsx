    ...
    <div className="flex flex-col h-full sm:h-[500px] bg-white sm:rounded-3xl border-0 sm:border border-slate-200 shadow-none sm:shadow-sm overflow-hidden font-sans">
      ...
      >
        <input 
          ...
          className="flex-1 bg-slate-100 border-none rounded-2xl px-4 py-2 text-sm outline-none focus:ring-2 focus:ring-[var(--color-primary)] transition-all font-bold"
        />
        <button 
          type="submit"
