...
import { Home, Package, LayoutGrid, BarChart2, User, Bell, Smartphone } from 'lucide-react';
...
export default function SupplierLayout({ children }: { children?: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans pb-24 md:pb-0">
      ...
      <Link to="/supplier/offers/new" className="fixed bottom-32 right-6 w-14 h-14 bg-slate-900 text-white rounded-2xl flex items-center justify-center shadow-2xl hover:scale-105 active:scale-95 transition-all z-50 md:bottom-10 md:right-10">
