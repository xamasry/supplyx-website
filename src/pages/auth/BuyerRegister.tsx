      ...
      <div className="flex-1 p-6 max-w-md mx-auto w-full">
        ...
        <form onSubmit={handleRegister} className="space-y-5">
           ...
           <div className="space-y-2 text-right">
             ...
             <input type="text" placeholder="مثال: مطعم الأمل" className="w-full px-4 py-4 bg-[#F8FAFC] border border-slate-100 rounded-2xl focus:ring-2 focus:ring-[#22C55E]/20 outline-none font-bold" required />
           </div>
           <div className="space-y-2 text-right">
