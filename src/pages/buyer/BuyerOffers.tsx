...
import { Search, Flame, Tag, Loader2 } from 'lucide-react';
            ...
            <div key={offer.id} className="bg-white border border-slate-300 rounded-3xl overflow-hidden shadow-sm hover:border-[var(--color-primary)] transition-colors flex flex-col">
              ...
              <div className="p-5 flex-1 flex flex-col">
                ...
                <div className="mt-auto pt-4 border-t border-slate-100 flex items-center justify-between">
                  ...
                  <button className="bg-[var(--color-primary)]/10 text-[var(--color-primary)] hover:bg-[var(--color-primary)] hover:text-white px-4 py-2 rounded-xl font-bold text-sm transition-colors shadow-sm flex items-center gap-2">
                    <Flame className="w-4 h-4" /> طلب الآن
                  </button>
                </div>
              </div>
            </div>
