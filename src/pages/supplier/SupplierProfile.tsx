...
import { User, Truck, MapPin, Bell, CreditCard, FileText, HelpCircle, LogOut } from 'lucide-react';
    ...
    <div className="space-y-6 md:pb-0 px-2 sm:px-0 font-sans">
      ...
      <div className="bg-[var(--color-primary)] text-white rounded-3xl p-6 shadow-lg flex items-center gap-4 relative overflow-hidden">
        ...
        <div className="w-16 h-16 rounded-full border-2 border-white/20 bg-white/10 flex items-center justify-center overflow-hidden shrink-0 z-10">
          <img src="https://ui-avatars.com/api/?name=شركة+التوريدات&background=transparent&color=fff" alt="Logo" className="w-full h-full object-cover" />
        </div>
        <div className="z-10">
          <h2 className="font-bold text-2xl font-display">شركة التوريدات</h2>
          <p className="text-white/80 text-sm mt-1 mb-2">محمد علي (مدير المبيعات)</p>
        ...
        <div className="bg-white rounded-3xl p-6 border border-slate-200 shadow-sm">
          ...
          <div className="space-y-4">
             <div>
              ...
              <p className="font-bold text-slate-800" dir="ltr">12345-67890-XYZ</p>
            </div>
            <div>
              <p className="text-[10px] text-slate-500 font-bold mb-1">رقم الهاتف للطلبات</p>
              <p className="font-bold text-slate-800" dir="ltr">+20 100 987 6543</p>
            </div>
            <div>
              ...
              <p className="font-bold text-slate-800 flex items-start gap-1">
                <MapPin className="w-4 h-4 text-slate-400 mt-0.5" /> المنطقة الصناعية، شبرا الخيمة
              </p>
            </div>
